...
so that `--enable-features=UseOzonePlatform --ozone-platform-hint=auto` are passed as parameters
...
# ...
Exec=/opt/Lens/lens-desktop --enable-features=UseOzonePlatform --ozone-platform-hint=auto %U
# ...
```
